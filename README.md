...
3. Launch Your EC2 (Elastic Compute Cloud)
...
```Bash
URI: 954976285001.dkr.ecr.us-east-1.amazonaws.com/c-cancer
```
...
AWS_ECR_LOGIN_URI = 954976285001.dkr.ecr.us-east-1.amazonaws.com
ECR_REPOSITORY_NAME = c-cancer
```
